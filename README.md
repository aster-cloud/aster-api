...
| 变量 | 说明 | 默认值                                             |
|---|---|-------------------------------------------------|
| `QUARKUS_DATASOURCE_JDBC_URL` | JDBC URL | `jdbc:postgresql://localhost:5432/aster_policy` |
| `QUARKUS_DATASOURCE_USERNAME` | 数据库用户名 | `postgres`                                      |
| `QUARKUS_DATASOURCE_PASSWORD` | 数据库密码 | `postgres`                                      |
| `QUARKUS_DATASOURCE_REACTIVE_URL` | Reactive URL | `postgresql://localhost:5432/aster_policy`      |
