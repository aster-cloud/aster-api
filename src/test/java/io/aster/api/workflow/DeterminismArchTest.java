...
import io.aster.workflow.ReplayDeterministicRandom;
import io.aster.workflow.ReplayDeterministicUuid;
import io.aster.workflow.ReplayDeterministicClock;
...
class DeterminismArchTest {
    private static final JavaClasses CLASSES = new ClassFileImporter()
            ...
            .importPackages("io.aster.api.workflow");
    ...
    void workflowCodeShouldNotCallInstantNow() {
        ...
        ArchRule rule = noClasses()
                .that()
                .resideInAPackage("io.aster.api.workflow..")
                .and()
